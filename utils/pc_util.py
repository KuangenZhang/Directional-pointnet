...
def point_cloud_three_views(points):
    ...
    # yrot is in-plane
    # zrot is elevation
    img1 = draw_point_cloud(points, zrot=0/180.0*np.pi, xrot=0/180.0*np.pi, yrot=0/180.0*np.pi)
    img2 = draw_point_cloud(points, zrot=45/180.0*np.pi, xrot=0/180.0*np.pi, yrot=0/180.0*np.pi)
    img3 = draw_point_cloud(points, zrot=90.0/180.0*np.pi, xrot=0/180.0*np.pi, yrot=0/180.0*np.pi)
